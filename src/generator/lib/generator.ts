import { bytesFromLandAndWaterEncounterRates } from "@lib/dataConverters/encounterRates"
import { bytesFromContestEncounters, bytesFromFishingEncounters, bytesFromLandAndWaterEncounters, bytesFromTreeAndRockEncounters } from "@lib/dataConverters/encounters"
import { dataHunkFromMapObjectEvent } from "@lib/dataConverters/mapObjectEvent"
import { bytesFromOddEgg } from "@lib/dataConverters/oddEgg"
import { frameTypeValue, primaryOptionsValue, printToneValue, secondaryOptionsValue } from "@lib/dataConverters/options"
import { bytesForEvolutionsAndLevelUpMovesFromPokemon, bytesForInfoFromPokemon } from "@lib/dataConverters/pokemon"
import { bytesFromTrade } from "@lib/dataConverters/trades"
import { updateEncounterRates } from "@lib/gameDataProcessors/encounterRates"
import { updateRandomEncounters } from "@lib/gameDataProcessors/encounters"
import { updateEventPokemon, updateEventPokemonMoves } from "@lib/gameDataProcessors/eventPokemon"
import { updateEvolutionMethods } from "@lib/gameDataProcessors/evolutionMethods"
import { updateIntroPokemon } from "@lib/gameDataProcessors/introPokemon"
import { shuffleItems, updateAccessLogic, updateItems } from "@lib/gameDataProcessors/itemLocations"
import { updateLevelUpMoves } from "@lib/gameDataProcessors/levelUpMoves"
import { updateMapObjectEvents } from "@lib/gameDataProcessors/mapObjectEvents"
import { updateMarts } from "@lib/gameDataProcessors/marts"
import { updateMoveTutorCost } from "@lib/gameDataProcessors/moveTutorCost"
import { updateNumberOfBadgesForOak } from "@lib/gameDataProcessors/numberOfBadgesForOak"
import { updateNumberOfMiltankBerries } from "@lib/gameDataProcessors/numberOfMiltankBerries"
import { updatePokemonInfo } from "@lib/gameDataProcessors/pokemonInfo"
import { updatePrices } from "@lib/gameDataProcessors/prices"
import { updateStarterItems, updateStarters } from "@lib/gameDataProcessors/starters"
import { updateTeachableMoves } from "@lib/gameDataProcessors/teachableMoves"
import { updateTrades } from "@lib/gameDataProcessors/trades"
import { updateTrainerClassNames, updateTrainerNames } from "@lib/gameDataProcessors/trainerNames"
import { updateTrainers } from "@lib/gameDataProcessors/trainers"
import { updateUnownSets } from "@lib/gameDataProcessors/unownSets"
import { encountersGroupedByType } from "@mainShared/encounterUtils"
import type { PlayerOptionsParams } from "@mainShared/generatorUtils"
import { Patch } from "@mainShared/patch"
import { Random } from "@mainShared/random"
...
import { bankAddressOfROMOffset, defaultROMInfo, markROMBytesAsUnused, type ROMInfo, romOffsetFromBankAddress } from "@shared/romUtils/romInfo"
...
export const computeGeneratorData = (params: {
...
export const computePlayerSpecificPatches = (params: PlayerOptionsParams) => {
  const {
    seed,
    settings,
    playerOptions,
  ...
  return {
    playerSpecificGameData: gameData,
    hunks: hunks,
  }
}
