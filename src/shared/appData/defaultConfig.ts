    ...
    subElementConfigs: {
      POKEMON: {
        ...
        subElementConfigs: {
          ...
          CHANGE_TRADE_EVOLUTION_METHODS: {
            label: "Change Trade Evolution Methods",
            description: "Change the Pokémon that evolve by trading to evolve by level instead (or by Water Stone in the case of Slowpoke into Slowking).",
            type: "FormSection" as const,
            layout: "vertical" as const,
            hasToggle: true as const,
            toggleValue: false,
            subElementConfigs: {
              ...
              SECOND_EVO_LEVEL: {
                label: "Second Evolution Level",
                description: "The evolution level for trade evolution Pokémon that have already evolved.",
                type: "IntegerInput" as const,
                required: true as const,
                min: 1,
                max: 100,
          ...
          CHANGE_TIME_EVOLUTION_METHODS: {
            label: "Change Time Based Evolutions",
            description: "Changes Espeon and Umbreon to evolve using Sun and Moon stones respectively.",
            type: "ToggleInput" as const,
            value: false,
          },
          DECREASE_HIGH_EVOLUTION_LEVELS: {
            label: "Change Trade Evolution Methods",
            description: "Decrease the level at which some Pokémon evolve if they would normally exceed a certain threshold.",
            type: "FormSection" as const,
            layout: "vertical" as const,
            hasToggle: true as const,
            toggleValue: false,
            subElementConfigs: {
              FIRST_EVO_THRESHOLD: {
                label: "Max First Evolution Level",
              ...
              SECOND_EVO_THRESHOLD: {
                label: "Max Second Evolution Level",
          ...
          HAPPINESS_EVOLUTION_REQUIREMENT: {
            label: "Happiness Evolution Requirement",
